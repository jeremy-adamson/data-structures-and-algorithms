...
const sortPeopleBetter = (arr) => {
  return arr.sort((a,b) => {
    let compareLast = a.lastName.localeCompare(b.lastName);
    if (compareLast !== 0){
      return compareLast;
    }
    else{
      let compareFirst = a.firstName.localeCompare(b.firstName);
      if (compareFirst !==0){
        return compareFirst;
      } else{
        return (a.age - b.age);
...
const sortMeetingsByDay = (arr) => {
  return arr.sort((a,b) => {
    ...
    return (weekday[a.dayOfWeek] - weekday[b.dayOfWeek]);
  });
};
...
const sortSchedule = (arr) => {
  ...
  return arr.sort((a, b) => {
    ...
    let dayCompare = weekday[a.dayOfWeek] - weekday[b.dayOfWeek];
    if (dayCompare !== 0){
      return dayCompare;
    } else {
